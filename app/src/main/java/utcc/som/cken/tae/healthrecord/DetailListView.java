...
public class DetailListView extends AppCompatActivity {
    ...
    private void synchornizeMySQL() {
        ...
        while (intTimes <= 1) {
            ...
            String strUrlUser = "http://www.hrecord.in.ht.122.155.171.20.no-domain.name/php/get_datauser.php";   // URL ของไฟล์ JSON ตาราง User
            String strUrlRecord = "http://www.hrecord.in.ht.122.155.171.20.no-domain.name/php/get_datarecord.php";
                ...
                for (int i = 0; i < objJsonArray.length(); i++) {
                    ...
                    switch (intTimes) {
                        ...
                        case 0:
                            ...
                            break;
                        default:
                            String strDate = object.getString("Days");
